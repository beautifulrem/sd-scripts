# Anima network base for LyCORIS-family modules such as LoHa and LoKr.
...
def get_anima_arch_config(unet, text_encoders) -> ArchConfig:
    """Validate an Anima model and return its adapter target configuration."""
    ...
    raise ValueError(f"Expected an Anima architecture. Module classes found: {sorted(module_class_names)}")
