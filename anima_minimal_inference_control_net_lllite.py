...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        choices=list(COND_INPUT_SPACES),
...
def generate_body(
    ...
    cond_vae = _get_cond_vae(args) if anima.lllite.cond_input_space == "latent" else None
